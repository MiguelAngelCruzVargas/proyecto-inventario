...
class SistemaLecheria(Frame):
    ...
    def create_widgets(self):
        ...
        sobres_label = Label(self.frame2, text=str(self.sobres_disponibles), fg='white', bg='navy', font=('Rockwell', 13, 'bold'))
        sobres_label.grid(column=1, row=6, pady=15)
    ...
    def actualizar_sobres_disponibles_label(self):
        sobres_label = self.frame2.grid_slaves(row=6, column=1)[0]
